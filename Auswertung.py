...
# Titel anzeigen
labeltitel = Label(master=tkFenster, text='Auswertung', fg='black', font=('Arial', 16))
labeltitel.place(x=0, y=5, width=400, height=30)

# Aufgaben anzeigen
# Kategorie
labelAusauf = Label(master=tkFenster, text='Aufgaben')
labelAusauf.place(x=0, y=40, width=200, height=27)
# Listbox
...
listboxAusauf.place(x=5, y=65, width=190, height=100)
# Scroolbar
...
textperioden = Label(master=tkFenster, text='Auflistung')
textperioden.place(x=340, y=100, width=100, height=27)

labelZeits = Label(master=tkFenster, bg='white')
labelZeits.place(x=340, y=130, width=300, height=27)

labelZeite = Label(master=tkFenster, bg='white')
labelZeite.place(x=340, y=160, width=300, height=27)
